...
trainer = VanillaGanNnTrainer(generator_neural_network=netG, discriminator_neural_network=netD, verbose=True, dtype=torch.float64, max_epoch_count=args["num_epochs"],batch_size=args["batch_size"], output_dir=OUTPUT_PATH, logger=LOGGER)
